...
gulp.task('build', gulp.series(gulp.parallel('clean:Skote', 'copy:libs'), 'scss'));
gulp.task('default', gulp.series(gulp.parallel('clean:Skote', 'copy:libs', 'scss'), gulp.parallel('watch')));
